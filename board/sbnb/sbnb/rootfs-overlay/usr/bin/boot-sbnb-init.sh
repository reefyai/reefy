...
setup_device_credentials() {
    PASSWORD_FILE="${SBNB_DATA_MNT}/state/device_password"
    ...
    if [ ! -f "${PASSWORD_FILE}" ]; then
        ...
        echo "[sbnb] Generated device password"
    fi
    ...
    # Users to configure — keep in sync with DEVICE_USERS in sbnb-mqtt-reconciler
    ...
    echo "[sbnb] Device credentials applied"
}
