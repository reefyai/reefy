...
INITRAMFS="${BINARIES_DIR}/rootfs-reefy.cpio"
INITRAMFS_DIR="${BINARIES_DIR}/rootfs-reefy"
...
# Place init script
cp "${BR2_EXTERNAL_REEFY_PATH}/board/reefy/reefy/scripts/init" "${INITRAMFS_DIR}"
