...
# This script automates Reefy Linux bootable USB creation process on macOS.
...
# Step 7: Ensure the ESP partition is mounted to /Volumes/reefy
espPath="/Volumes/reefy"
