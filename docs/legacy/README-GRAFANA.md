...
Replace:
- `reefy-F6S0R8000719` with your server's Tailscale hostname
...
```bash
ansible-playbook -i reefy-F6S0R8000719, \
  collections/ansible_collections/reefy/compute/playbooks/run-sysbench.yml
```
